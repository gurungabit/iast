...
class ValkeyClient:
    """Async Valkey/Redis client for PTY communication."""
    ...
    async def subscribe_to_gateway_control(
        ...
        """Subscribe to the global gateway control channel for session creation."""
    ...
    async def publish_output(self, session_id: str, data: str) -> None:
        """Publish output to a session's output channel."""
